(function (global) {
	...
	function buildMenuItemsViewHtml(categoryMenuItems,menuItemsTitleHtml,menuItemHtml) {
		var html=menuItemsTitleHtml;
		html=insertProperty(html,"name",categoryMenuItems.category.name);
		html=insertProperty(html,"special_instructions",categoryMenuItems.category.special_instructions);
		var finalHtml=html;
		finalHtml+="<section class='row'>"
